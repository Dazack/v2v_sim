...
#   This applies Qlearning on one scenario and then reuses the Qtable for the other scenario
#
# Helper Docs:
#
...
# Prepare csv writter
csv_file = open(f'qlearning_results/reuse/{scenario}__0_1__0_95__{EPISODES}.csv', 'w', encoding='UTF8', newline='')
...
print(q_table)
print("\n".join(summary))
print(f"Highest reward of second session at end is {highest_rew}")